// src/app/job-chat/JobChatClient.tsx
'use client';

import { useEffect, useMemo } from 'react';
import { useSearchParams } from 'next/navigation';
import { useJobChat, formatKST } from '@/features/job-chat/useJobChat';
import styles from '@/app/job-chat/page.module.css';

export default function JobChatClient() {
  const searchParams = useSearchParams();
  const jobParam = useMemo(() => searchParams.get('job') ?? null, [searchParams]);
  const {
    resolvedJobName,
    jobDescription,
    comments,
